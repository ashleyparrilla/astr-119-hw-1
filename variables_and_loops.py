import numpy as np  #numpy used for lots of things

def main():
	i = 0   #integers declared with a number
	n = 10  #another integer n 
	x = 119.0   #floating number (number with a decimal)
	
	#we can use numpy to declare array quickly
